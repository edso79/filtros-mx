...
| 2026-08-31 | **Revisión mensual de agosto: 10 de 10 aportaciones siguen cubiertas**, verificado contra las listas descargadas ese día (EasyList Spanish `202608311832`). Ninguna de las 10 reglas ha desaparecido ni se ha roto. **Recordatorio del límite que el propio script declara:** comprueba que la regla siga en la lista, no que siga funcionando — eso lo dice la revisión trimestral abriendo los sitios. En la misma sesión se hizo la **segunda carga de `codigoqro.mx` y `posta.com.mx`**, las dos candidatas del 25-ago: **las 11 filas medidas repiten al píxel** a seis días de distancia, con lo que ambas cumplen el estándar de envío | Revisión mensual, automatizada |
